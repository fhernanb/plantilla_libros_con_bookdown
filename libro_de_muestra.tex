...
\author{Autor 1 Fulanito \and Autor 2 Sutanito}
\date{2021-09-17}
...
\section*{Bienvenido}\label{bienvenido}}
...
\subsection*{Software y convenciones}\label{software-y-convenciones}}
\addcontentsline{toc}{subsection}{Software y convenciones}
...
{\centering \includegraphics[width=0.8\linewidth]{libro_de_muestra_files/figure-latex/nice-fig-1} 
...
\hypertarget{discri}{%
\section{Análisis Discriminante}\label{discri}}
...
\includegraphics{libro_de_muestra_files/figure-latex/myplot01-1.pdf}
...
\subsection{Ecuaciones dentro de un párrafo}\label{ecuaciones-dentro-de-un-puxe1rrafo}}
...
\subsection{Ecuaciones entre párrafos}\label{ecuaciones-entre-puxe1rrafos}}
